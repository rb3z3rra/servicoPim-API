...
const accessLogStream = fs.createWriteStream(path.join(logDirectory, 'access.log'), { flags: 'a' } // O 'a' garante que novos logs sejam empilhados sem apagar os antigos
);
