...
import { createEquipamentoSchemaDTO, updateEquipamentoSchemaDTO, } from "../dtos/EquipamentoSchemaDTO.js";
const equipamentoRoutes = Router();
const equipamentoController = new EquipamentoController();
equipamentoRoutes.post("/", authMiddleware, validarBody(createEquipamentoSchemaDTO), asyncHandler(equipamentoController.create.bind(equipamentoController)));
...
equipamentoRoutes.put("/:id", authMiddleware, validarBody(updateEquipamentoSchemaDTO), asyncHandler(equipamentoController.update.bind(equipamentoController)));
...
//# sourceMappingURL=equipamento.routes.js.map