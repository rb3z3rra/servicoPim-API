...
usuarioRoutes.post("/", validarBody(createUserSchemaDTO), asyncHandler(usuarioController.create.bind(usuarioController)));
...
usuarioRoutes.put("/:id", authMiddleware, validarBody(updateUserSchemaDTO), asyncHandler(usuarioController.update.bind(usuarioController)));
