...
import { AddGestorAndConfiguracaoPrazoAtendimento1713090000000 } from "./migrations/1713090000000-AddGestorAndConfiguracaoPrazoAtendimento.js";
...
export const appDataSource = new DataSource({
  ...
  entities: [Equipamento, OrdemServico, Usuario, HistoricoOS, ApontamentoOS, RefreshToken, ConfiguracaoPrazoAtendimento],
  migrations: [
    ...
    AddGestorAndConfiguracaoPrazoAtendimento1713090000000,
  ],
