...
export const createOrdemServicoSchema = z.object({
  equipamentoId: z.number({ required_error: "equipamentoId deve ser número" }),
  solicitanteId: z.string().uuid("solicitanteId inválido"),
...
export const atribuirTecnicoSchema = z.object({
  tecnicoId: z.string().uuid("tecnicoId inválido"),
});
...
export type CreateOrdemServicoSchemaDTO = z.infer<typeof createOrdemServicoSchema>;
export type AtribuirTecnicoSchemaDTO = z.infer<typeof atribuirTecnicoSchema>;
export type AtualizarStatusSchemaDTO = z.infer<typeof atualizarStatusSchema>;
export type ConcluirOrdemServicoSchemaDTO = z.infer<typeof concluirOrdemServicoSchema>;
